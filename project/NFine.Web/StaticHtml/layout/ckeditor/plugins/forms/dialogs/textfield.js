...
function (b) {
    ...
    return {
        ...
        onShow: function () {
            ...
            var a = this.getParentEditor().getSelection().getSelectedElement(); !a || "input" != a.getName() || !g[a.getAttribute("type")] && a.getAttribute("type") || (this.textField = a, this.setupContent(a))
        },
        onOk: function () {
        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                    id: "_cke_saved_name",
                    type: "text",
                    label: '数据库字段设计', // b.lang.forms.textfield.name,
                    "default": "",
                    accessKey: "N",
                    setup: function (a) {
                ...
                },
                {
                    id: "value",
                    type: "text",
                    label:'字段对应名称',// b.lang.forms.textfield.value,
                    "default": "",
                    accessKey: "V",
                    commit: function (a) {
