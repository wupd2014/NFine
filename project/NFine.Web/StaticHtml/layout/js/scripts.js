...
$(document).ready(function () {
    ...
    $("[data-target=#sourceModal]").click(function (e) {
        ...
        //        $.post('Handler1.ashx', { data: $(".demo").html() }, function (data) {
        //            // 回调
        //        });
    });
    ...
    $(".nav-header").click(function () {
        ...
        $("i").filter(".icon-minus").removeClass("icon-minus").addClass("icon-plus");
        $(this).find('i').filter(".icon-plus").removeClass("icon-plus").addClass("icon-minus");
        $(this).next().slideDown()
    });
    $('#undo').click(function () {
        stopsave++;
